...
# GBIF (Global Biodiversity Information Facility) records
# See exemple in:
# https://ropensci.org/blog/2013/07/29/rwbclimate-rgbif/
...
# plot them afterward cf. 'geom_point()' below
...
# General ggplot2 theme for the map
